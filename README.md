...
Install project using ubuntu terminal
...
nano requirements.txt [ enter the requirements.txt file]
pip install -r requirements.txt #install
nano codefortune.py
streamlit run codefortune.py
```
...
------------------------------------------------------------------------------------------------------------
#[ enter the requirements.txt file] #create the nano file then paste the below requirements.txt file content
---------------------------------------------------
